...
public final class GreetServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<masche.example.greet.v1.GreetRequest,
      masche.example.greet.v1.GreetResponse> getGreetMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Greet",
      requestType = masche.example.greet.v1.GreetRequest.class,
      responseType = masche.example.greet.v1.GreetResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<masche.example.greet.v1.GreetRequest,
      masche.example.greet.v1.GreetResponse> getGreetMethod() {
    io.grpc.MethodDescriptor<masche.example.greet.v1.GreetRequest, masche.example.greet.v1.GreetResponse> getGreetMethod;
      ...
      synchronized (GreetServiceGrpc.class) {
        if ((getGreetMethod = GreetServiceGrpc.getGreetMethod) == null) {
          GreetServiceGrpc.getGreetMethod = getGreetMethod =
              io.grpc.MethodDescriptor.<masche.example.greet.v1.GreetRequest, masche.example.greet.v1.GreetResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Greet"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  masche.example.greet.v1.GreetRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  masche.example.greet.v1.GreetResponse.getDefaultInstance()))
  ...
  public static abstract class GreetServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void greet(masche.example.greet.v1.GreetRequest request,
  ...
  public static final class GreetServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GreetServiceBlockingStub> {
     ...
     * </pre>
     */
    public masche.example.greet.v1.GreetResponse greet(masche.example.greet.v1.GreetRequest request) {
  ...
  public static final class GreetServiceFutureStub extends io.grpc.stub.AbstractFutureStub<GreetServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<masche.example.greet.v1.GreetResponse> greet(
        masche.example.greet.v1.GreetRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREET:
          serviceImpl.greet((masche.example.greet.v1.GreetRequest) request,
              (io.grpc.stub.StreamObserver<masche.example.greet.v1.GreetResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GreetServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return masche.example.greet.v1.Greet.getDescriptor();
    }
